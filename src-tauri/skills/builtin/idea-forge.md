---
name: Idea Forge
description: Constraint-driven creative ideation — generate project concepts from requirements
type: passive
match: ""
---
...
1. **[One-line pitch]**
   ...
   time [weekend / week / month] * tech [stack]
...
1. **`git whatsup` — show what happened while you were away**
   ...
   time weekend * tech Python, GitPython, click
...
2. **`explain 503` — HTTP status codes for humans**
   ...
   time weekend * tech Rust or Go, static dataset
...
3. **`deps why <package>` — why is this in my dependency tree**
   ...
   time weekend * tech Node.js, npm/yarn lockfile parsing
```
